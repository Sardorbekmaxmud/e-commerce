...
# Testlar uchun SQLite3 ishlatish
if 'test' in sys.argv:
    DATABASES['default'] = {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': ':memory:',  # Bu vaqtincha in-memory SQLite bazasini ishlatadi
    }
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'account.serializers.CustomUserCreateSerializer',  # Custom serializer ni qo‘shamiz
    }
}
